...
#             <input type="text" id="transactionLocation" name="transactionLocation" required>
#             
#             <label for="transactionTime">Transaction Time (24-hour format):</label>
...
#     let message = 'Transaction seems normal.';
# 
#     // Fraud detection rules
#     if (transactionAmount > 1000) {
#         isFraudulent = true;
#         message = 'Transaction amount is unusually high!';
#     } else if (parseInt(transactionTime.split(':')[0]) < 6 || parseInt(transactionTime.split(':')[0]) > 22) {
#         isFraudulent = true;
#         message = 'Transaction made at unusual hours!';
#     } else if (transactionLocation.toLowerCase() === 'unknown') {
#         isFraudulent = true;
#         message = 'Transaction made from an unknown location!';
#     }
# 
#     // Update the result div with the status message
#     const resultDiv = document.getElementById('result');
#     const statusMessage = document.getElementById('statusMessage');
#     
#     statusMessage.textContent = isFraudulent ? `Fraud Detected: ${message}` : 'No fraud detected.';
